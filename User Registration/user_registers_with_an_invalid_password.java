...
public class UserRegistersWithAnInvalidPassword {
  ...
  @Test
  public void testUserRegistersWithAnInvalidPassword() throws Exception {
    driver.get(baseUrl + "/");
    ...
    driver.findElement(By.name("password")).sendKeys("X");
